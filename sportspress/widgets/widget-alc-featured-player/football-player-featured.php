<?php
/**
 * Featured Player - American Football
 *
 * @author    Dan Fisher
 * @package   Alchemists
 * @since     4.2.5
...
if ( $team_color_heading || $team_color_primary || $team_color_secondary ) {
	$output .= '<style>';
		if ( $team_color_primary ) {
			$output .= '.' . $identifier . ' .widget-player__inner::before {';
...
<div class="widget-player widget-player--football card <?php echo esc_attr( $style_type ); ?> <?php echo esc_attr( $identifier ); ?>">
	<?php if ( $caption ) {
